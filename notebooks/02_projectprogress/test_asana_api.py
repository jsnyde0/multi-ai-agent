...
project_gid = os.environ['ASANA_PROJECT_GID'] # str | Globally unique identifier for the project.
opts = {
    'completed_since': "2024-11-14T02:06:58.158Z", # str | Only return tasks that are either incomplete or that have been completed since this time. Accepts a date-time string or the keyword *now*. 
